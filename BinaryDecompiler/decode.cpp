...
const uint32_t* DecodeDeclaration(Shader* psShader, const uint32_t* pui32Token, Declaration* psDecl)
{
    ...
    switch (eOpcode)
    {
        ...
        case OPCODE_DCL_INTERFACE:
        {
            ...
            psDecl->value.interface2.ui32InterfaceID = interfaceID;
            psDecl->value.interface2.ui32NumFuncTables = numClassesImplementingThisInterface;
            psDecl->value.interface2.ui32ArraySize = arrayLen;
