...
#undef DT
		...
		*combined = false;
		...
		else
		{
			...
			for (int component = 0; component < 4; component++) {
				...
				char *swiz_offset = (char*)"";
				switch (swiz_offsets[component]) {
					case  0: break;
					case  4: swiz_offset = (char*)"+1"; break;
					case  8: swiz_offset = (char*)"+2"; break;
					case 12: swiz_offset = (char*)"+3"; break;
					default: swiz_offset = (char*)"+?"; break;
				}
	...
	{
		assert(instr != NULL);
		char * componentX = (char*)"x";
		char* componentY = (char*)"y";
		char* componentZ = (char*)"z";
		char* componentW = (char*)"w";
